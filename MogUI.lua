-- =============================================
-- MOGUI - Clean Fixed Version (March 2026)
-- Proper Automatic Sizing • No Overlapping • Better Spacing
-- =============================================
...
-- ==================== GROUPBOX (Fixed Automatic Sizing) ====================
...
function MogUI:CreateGroupbox(parent, title)
    ...
    -- Add your existing AddToggle, AddSlider, AddDropdown, AddColorPicker here
    -- They should all use fixed heights like 48-65 studs and the container will auto-expand
